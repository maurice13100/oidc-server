...
public class UpdateUserDTO {
	...
	public boolean equals(Object o) {
		...
		if (password != null ? !password.equals(userDTO.password) : userDTO.password != null)
			return false;
		if (matchingPassword != null ? !matchingPassword.equals(userDTO.matchingPassword)
				: userDTO.matchingPassword != null)
			return false;
		if (email != null ? !email.equals(userDTO.email) : userDTO.email != null)
			return false;
		if (phone != null ? !phone.equals(userDTO.phone) : userDTO.phone != null)
			return false;
		if (givenName != null ? !givenName.equals(userDTO.givenName) : userDTO.givenName != null)
			return false;
		if (familyName != null ? !familyName.equals(userDTO.familyName) : userDTO.familyName != null)
			return false;
		if (middleName != null ? !middleName.equals(userDTO.middleName) : userDTO.middleName != null)
			return false;
		if (gender != null ? !gender.equals(userDTO.gender) : userDTO.gender != null)
			return false;
		if (birthdate != null ? !birthdate.equals(userDTO.birthdate) : userDTO.birthdate != null)
			return false;
		if (streetAddress != null ? !streetAddress.equals(userDTO.streetAddress) : userDTO.streetAddress != null)
			return false;
		if (locality != null ? !locality.equals(userDTO.locality) : userDTO.locality != null)
			return false;
		if (region != null ? !region.equals(userDTO.region) : userDTO.region != null)
			return false;
		if (postalCode != null ? !postalCode.equals(userDTO.postalCode) : userDTO.postalCode != null)
			return false;
