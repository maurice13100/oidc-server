...
@NamedQueries({@NamedQuery(name = UserConnection.QUERY_BY_CLIENT_ID,
    query = "select uc from UserConnection uc where uc.clientId = :"
...
public class UserConnection {
  ...
  /**
   * @param date The connection date to set
   */
  ...
  /**
   * @param client id The client id to set
   */
  ...
  /**
   * @param isSuccess The flag success to set
   */
  ...
  /**
   * @param isSentSms The flag sentSms to set
   */
