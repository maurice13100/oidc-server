...
<li class="divider"></li>
<li class="nav-header"><spring:message code="sidebar.developer.title"/></li>
<li><a href="manage/#dev/dynreg" data-toggle="collapse" data-target=".nav-collapse">Editing a Client</a><li>
<li><a href="manage/#dev/resource" data-toggle="collapse" data-target=".nav-collapse">Editing a Protected Resource</a><li>
</security:authorize>